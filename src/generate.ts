...
function formatDeployments(npmPackageName: string, network: any, githubBaseUrl: string, projectRoot: string): Array<any> {
  const result: any[] = []
...
export async function generate(name: string, outputFilePath: string, npmPackageName: string, githubBaseUrl: string) {
